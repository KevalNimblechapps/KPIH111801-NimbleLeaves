...
class CustomTheme extends Theme {
  ...
  static Color active = const Color.fromRGBO(78, 125, 254, 1);
  static Color greydark = const Color.fromRGBO(119, 140, 161, 1);
  static Color greylight = const Color.fromRGBO(193, 193, 193, 1);
  static Color greymedium = const Color.fromRGBO(216, 216, 216, 1);
                        ...
                        new Align(
                            ...
                            child: new Padding(
                              ...
                              child: RaisedButton(
                                ...
                                // _validateInputs,
                                color: validation() == true ? active : greydark,
                                splashColor:
                                    validation() == true ? active : greydark,
                                highlightColor:
                                    validation() == true ? active : greydark,
                                highlightElevation: 0,
                                elevation: 0,
