...
class Dashboard extends StatefulWidget {
  Dashboard({Key key, this.duration}) : super(key: key);
...
class _Dashboardpage extends State<Dashboard> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    startTimeout(1500);
    return new Scaffold(
      endDrawer: new DrawerOnly(dashboard: true),
      key: _scaffoldKey,
      appBar: new AppBar(
