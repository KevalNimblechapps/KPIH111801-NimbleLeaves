...
import 'package:nimble_leaves/blank.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        unselectedWidgetColor: CustomColors.active,
        textTheme: TextTheme(
          headline: TextStyle(
            fontSize: 18.0,
          ),
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: OutlineButton(
          ...
          borderSide: BorderSide(color: CustomColors.active),
          highlightColor: Color.fromRGBO(248, 250, 251, 1),
          highlightedBorderColor: CustomColors.active,
