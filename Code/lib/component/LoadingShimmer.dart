...
class LoadingShimmer extends StatelessWidget {
  Widget build(BuildContext context) {
    ...
    List<Widget> unplanned = new List.generate(2, (i) => new Unplanned());
...
class CustomCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Shimmer.fromColors(
        baseColor: CustomColors.shimmer,
...
class UnplannedLoadingShimmer extends StatelessWidget {
  Widget build(BuildContext context) {
    List<Widget> cards = new List.generate(2, (i) => new Unplanned());
...
class Unplanned extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new Shimmer.fromColors(
        baseColor: CustomColors.shimmer,
